...
class SparkClassCommandBuilder extends AbstractCommandBuilder {
  ...
  public List<String> buildCommand(Map<String, String> env)
    ...
    switch (className) {
      ...
      case "org.apache.spark.deploy.shuffleService.CherryServiceRunner":
        javaOptsKeys.add("REMOTE_SHUFFLE_SERVICE_DAEMON_JAVA_OPTS");
        javaOptsKeys.add("REMOTE_SHUFFLE_SERVICE_OPTS");
        extraClassPath = getenv("SPARK_DAEMON_CLASSPATH");
        memKey = "REMOTE_SHUFFLE_SERVICE_MEMORY";
        break;
