...
private[spark] class SortShuffleManager(conf: SparkConf) extends ShuffleManager with Logging {
  ...
  override def getReader[K, C](
    ...
    logInfo(s"SortShuffleManager getReader: $startMapIndex, $endMapIndex, $startPartition, $endPartition")
    logInfo(s"handle.shuffleId: ${handle.shuffleId}")
  ...
  override def getWriter[K, V](
    ...
    handle match {
      case unsafeShuffleHandle: SerializedShuffleHandle[K @unchecked, V @unchecked] =>
        logInfo("Writer class: UnsafeShuffleWriter")
      ...
      case bypassMergeSortHandle: BypassMergeSortShuffleHandle[K @unchecked, V @unchecked] =>
        logInfo("Writer class: BypassMergeSortShuffleWriter")
      ...
      case other: BaseShuffleHandle[K @unchecked, V @unchecked, _] =>
        logInfo("Writer class: SortShuffleWriter")
