...
private[deploy] class Worker(
  ...
  private val shuffle_service_availability = conf.get(config.SHUFFLE_SERVICE_AVAILABILITY)
  ...
  private val shuffleService = if (shuffle_service_availability != "cherry") {
    if (externalShuffleServiceSupplier != null) {
  ...
  override def onStart(): Unit = {
    ...
    if (shuffle_service_availability != "cherry") {
