...
private[spark] object CoarseGrainedClusterMessages {
  ...
  //case class LaunchTaskForCherry(data: SerializableBuffer, stageId: Int) extends CoarseGrainedClusterMessage
  case class LaunchTaskForCherry(appId: String, partitionId: Int, stageId: Int) extends CoarseGrainedClusterMessage

  case class ClearCache() extends CoarseGrainedClusterMessage

  case class LaunchTaskDescrWithTask(data: SerializableBuffer, task: SerializableBuffer) extends CoarseGrainedClusterMessage

  case class BroadCastTaskBinary(
                                  taskBinary: Array[Byte]) extends CoarseGrainedClusterMessage
  /*case class BroadCastTaskBinaryForShuffleMapStage(
                                                  stageId: Int,
                                                  stageType: String,
                                                  stageRDD: RDD[_],
                                                  stageShuffleDep: ShuffleDependency[_, _, _]) extends CoarseGrainedClusterMessage
  case class BroadCastTaskBinaryForResultStage(
                                                stageId: Int,
                                                stageType: String,
                                                stageRDD: RDD[_],
                                                stageFunc: (TaskContext, Iterator[_]) => _) extends CoarseGrainedClusterMessage
  */
  case class SerMapStatusForShuffleMapStage(data: Array[Byte], mapStatus: Array[Byte]) extends CoarseGrainedClusterMessage
  case class SerMapStatusForShuffleMapStageUnion(data: Array[Byte], mapStatus: Array[Array[Byte]]) extends CoarseGrainedClusterMessage
  case class SerMapStatusForResultStage(data: Array[Byte], mapStatus: Array[Byte]) extends CoarseGrainedClusterMessage


  case class RegisterNewCherryNode(data: Array[Byte]) extends CoarseGrainedClusterMessage
  case class DeregisterCherryNode(data: Array[Byte]) extends CoarseGrainedClusterMessage
  case class DeregisterExec() extends CoarseGrainedClusterMessage
  case class NewCherryNodeRegistered(data: Array[Byte]) extends CoarseGrainedClusterMessage
  case class GetCherryNodesInfo() extends CoarseGrainedClusterMessage
  ...
  case class InformDriverSchedulerAboutCherryNodes(array: Array[String]) extends CoarseGrainedClusterMessage
