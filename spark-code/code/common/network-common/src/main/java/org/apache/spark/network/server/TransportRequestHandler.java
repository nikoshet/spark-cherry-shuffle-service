...
public class TransportRequestHandler extends MessageHandler<RequestMessage> {
  ...
  private void processStreamUpload(final UploadStream req) {
    ...
    try {
      ...
      //logger.trace("Req Body: "+req.body()+", Req BodyByteCount: "+req.bodyByteCount+ ", Req Meta: "+req.meta);
      // Req Body: null, Req BodyByteCount: 12147, Req Meta: NettyManagedBuffer[buf=UnpooledSlicedByteBuf(ridx: 0, widx: 197, cap: 197/197, unwrapped: PooledUnsafeDirectByteBuf(ridx: 226, widx: 1024, cap: 1024))]
