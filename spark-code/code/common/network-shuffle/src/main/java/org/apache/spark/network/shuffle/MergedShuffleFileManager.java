...
public interface MergedShuffleFileManager {
  ...
  StreamCallbackWithID receiveBlockDataAsStream(UploadBlockStream msg);

  StreamCallbackWithID receiveBlockDataAsStream(UploadBlockStream msg, ExternalShuffleBlockResolver blockManager);

  StreamCallbackWithID receiveBlockDataAsStream(UploadBlockStream msg, RemoteShuffleBlockResolver blockManager);
